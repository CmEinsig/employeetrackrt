//Required information and packages
    ...
    inquirer.prompt([
        {
            ...
            choices: ['View Departments', 'View Roles', 'View Employees', 'View Department Budget', 
            'Update Employee','Add Department', 'Add Role', 'Add Employee', 'Delete Department', 
            'Delete Role', 'Delete Employee', 'Exit Employee Tracker'],
            pageSize: 12
        }
    ]).then((answers) => {
        switch(answers.init) {
...
// Add Roles: title, salary, department
function addRole() {
    const array = [];
    getDepartmentsAsync()
    .then(data => {
